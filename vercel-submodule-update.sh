# Source of this shell script: https://dev.to/beeinger/submodules-with-vercel-and-nextjs-4gml

# SUBMODULE_GITHUB is github submodule repo address without https:// prefix
